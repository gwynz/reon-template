		...
		articles: [
			{
				...
				date: "JUNE 24, 2024",
				excerpt:
					"I used to think that playing board games with my family would be a surprisingly deep strategy game.",
				image:
		...
		articles: [
			{
				...
				date: "JUNE 24, 2024",
				excerpt:
					"We've collected our favorite guides—from dozens of guides and hundreds of hours of testing—to help you work from home more effectively and comfortably.",
				image:
		...
		articles: [
			{
				...
				date: "JUNE 17, 2024",
				excerpt:
					"Gaming chairs can be cheap and uncomfortable. The Secretlab Titan Evo 2022 series gets the basics without skimping on comfort.",
				image:
					"https://images.pexels.com/photos/4348401/pexels-photo-4348401.jpeg?auto=compress&cs=tinysrgb&w=600",
			},
			{
		...
		articles: [
			{
				...
				date: "JUNE 14, 2024",
				excerpt:
					"Because a self-rescuing booster and jumper is a must-have tool for any road trip, we tested the best portable jump starters on the market.",
				image:
					"https://images.pexels.com/photos/4348401/pexels-photo-4348401.jpeg?auto=compress&cs=tinysrgb&w=600",
			},
			{
		...
		articles: [
			{
				...
				date: "JUNE 24, 2024",
				excerpt:
					"We've secured exclusive discounts for Wirecutter readers on luggage, travel goods, outdoor water-resistant bedding, swimwear, and more.",
				image:
					"https://images.pexels.com/photos/4348401/pexels-photo-4348401.jpeg?auto=compress&cs=tinysrgb&w=600",
			},
			{
