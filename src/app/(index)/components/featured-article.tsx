		...
		<article>
			...
			<div className="cursor-pointer group">
				<div className="relative mb-8">
					<div className="bg-transparent min-h-[400px] flex items-center justify-center">
						<div className="w-full h-full transition-transform duration-300 transform rotate-0 bg-white shadow-lg group-hover:rotate-2 group-hover:scale-102">
							<img
